...
import com.development.johnhrapp.databinding.UpcomingShiftsLayoutBinding;
import com.development.johnhrapp.model.UpcomingShift;
import com.development.johnhrapp.view.ViewJobOne;
import com.development.johnhrapp.view.ViewMyJob;
...
public class UpcomingShiftAdapter extends RecyclerView.Adapter<UpcomingShiftAdapter.MyViewHolder> {
    ...
    public UpcomingShiftAdapter(Context context,List<UpcomingShift> shiftList) {
