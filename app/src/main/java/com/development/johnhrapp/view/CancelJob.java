...
public class CancelJob extends AppCompatActivity implements View.OnClickListener {
ActivityCancelJobBinding cancelJobBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancelJobBinding = DataBindingUtil.setContentView(this,R.layout.activity_cancel_job);
        setClickListener();
        setReyclerView();
        upcomingJobShift();
    }
    ...
    private void setClickListener(){
        cancelJobBinding.back.setOnClickListener(this);
    }
    ...
    private void setReyclerView(){
        ...
        mLayoutManager = new LinearLayoutManager(CancelJob.this);
        cancelJobBinding.recyclerView.setLayoutManager(mLayoutManager);
        cancelJobBinding.recyclerView.setItemAnimator(new DefaultItemAnimator());
        cancelJobBinding.recyclerView.setAdapter(mAdapter);
    }
