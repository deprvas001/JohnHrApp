...
import com.development.johnhrapp.databinding.FragmentMonthCalendarBinding;
import com.development.johnhrapp.view.AddAvailability;
import com.development.johnhrapp.view.AddHoliday;

public class MonthCalendar extends Fragment implements View.OnClickListener {
FragmentMonthCalendarBinding calendarBinding;
View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        calendarBinding = DataBindingUtil.inflate(inflater,R.layout.fragment_month_calendar, container, false);
